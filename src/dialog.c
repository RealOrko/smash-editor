...
void dialog_shortcuts(Editor *ed) {
    ...
    static const char *shortcuts[] = {
        ...
        "",
        "View:",
        "  Ctrl+Alt+H     Toggle hex mode",
        "  Ctrl+Alt+E     Toggle file panel",
        "",
        "File Panel / Explorer:",
        "  Shift+Tab      Switch panel/editor focus",
        "  Arrows         Navigate entries",
        "  Shift+Up/Down  Multi-select files",
        "  Enter          Open file/directory",
        "  Backspace      Go to parent directory",
        "  Type chars     Filter entries",
